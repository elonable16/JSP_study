...
<body>
    ...
    <div id="content">
        <section id="main_section">
            ...
            <article class="main_article">
                <h1>Main Article</h1>
                <form action ="Ex0824_3.jsp" method="post">
                	<p>
            ...
            <article class="main_article">
                ...
                <form action ="./Ex0824_3.jsp" method = "post">
                	...
                	<p>
                		패스워드 : <input type = "password" name = "password2">
                	</p>
                	<p>
                		이름 : <input type = "text" name = "name2">
                	</p>
                	<p>
                		성별 : <input type ="radio" name = "sex" value = "남자" checked> 남성
                	...
                	<p><textarea name="comment" rows="3" cols="30"></textarea></p>
                	<p>
