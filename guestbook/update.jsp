		...
		<div id="section">
			<div id="article">
				<form method ="post" action = "./update_ok.jsp">
					<table>
						<tr>
							<td colspan="2" class = "td_title_long">수정하기</td>
						</tr>
						<tr>
							<td class = "td_title_base">번호</td>
							<td class = "td_contents">
								<p><input type ="text" name = "guest_num" value ="<%= guest_num%>" readonly = "readonly"><p>
						...
						<tr>
							...
							<td class = "td_contents">
								<p><input type ="text" name = "guest_subject" value ="<%= guest_subject%>"><p>
							</td>
						</tr>
						<tr>
							<td class = "td_title_base">날짜</td>
							<td class = "td_contents">
								<p><input type ="text" name = "guest_date" value ="<%= guest_date%>" readonly = "readonly"><p>
							</td>
						</tr>
						<tr>
							<td class = "td_title_base">작성자</td>
							<td class = "td_contents">
								<p><input type ="text" name = "guest_name" value ="<%= guest_name%>"><p>
							</td>
						</tr>
						<tr>
							<td class = "td_title_base">비밀번호</td>
							<td class = "td_contents">
								<p><input type ="password" name = "guest_passwd"><p>
							</td>
						</tr>
						<tr>
							<td class = "td_title_big">내용</td>
							<td class = "td_contents_big">
								<p><textarea cols ="70" rows="10" name = "guest_contents"><%= guest_contents%></textarea><p>
							</td>
						</tr>
						<tr>
