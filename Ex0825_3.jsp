    ...
    <div id="content">
        <section id="main_section">
            <article class="main_article">
                <h1>Main Article</h1>
                <form action="Ex0825_4.jsp" method ="post" enctype="multipart/form-data">
                	<span>파일 1 :<input type = "text" name = "title"></span>
                	<h3><input type = "file" name = "fileName"></h3>
                	<span>파일 2 :<input type = "text" name = "title2"></span>
                	<h3><input type = "file" name = "fileName2"></h3>
