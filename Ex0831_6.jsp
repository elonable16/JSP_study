...
<body>
<%
	//session.removeAttribute("passward"); // 세션 하나만 삭제
	//session.invalidate();// 세션변수 모두 일시 삭제
	//out.print("세션변수를 삭제했습니다.<br>");
	session.setMaxInactiveInterval(1800);
	int time = session.getMaxInactiveInterval()/60;
	out.print("세션의 기본 유효시간 : " + time+"분 <br>");
	//session.setMaxInactiveInterval(60);
	//time = session.getMaxInactiveInterval()/60;
	//out.print("세션의 변경된 유효시간 : " + time+"분 <br>");
